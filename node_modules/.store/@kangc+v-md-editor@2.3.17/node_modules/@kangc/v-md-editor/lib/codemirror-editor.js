...
"use strict";
/* harmony import */ var _node_modules_mini_css_extract_plugin_dist_loader_js_node_modules_css_loader_dist_cjs_js_node_modules_vue_loader_dist_stylePostLoader_js_node_modules_postcss_loader_src_index_js_node_modules_sass_loader_dist_cjs_js_node_modules_vue_loader_dist_index_js_ref_2_0_codemirror_editor_vue_vue_type_style_index_0_lang_scss__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(105);
/* harmony import */ var _node_modules_mini_css_extract_plugin_dist_loader_js_node_modules_css_loader_dist_cjs_js_node_modules_vue_loader_dist_stylePostLoader_js_node_modules_postcss_loader_src_index_js_node_modules_sass_loader_dist_cjs_js_node_modules_vue_loader_dist_index_js_ref_2_0_codemirror_editor_vue_vue_type_style_index_0_lang_scss__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_mini_css_extract_plugin_dist_loader_js_node_modules_css_loader_dist_cjs_js_node_modules_vue_loader_dist_stylePostLoader_js_node_modules_postcss_loader_src_index_js_node_modules_sass_loader_dist_cjs_js_node_modules_vue_loader_dist_index_js_ref_2_0_codemirror_editor_vue_vue_type_style_index_0_lang_scss__WEBPACK_IMPORTED_MODULE_0__);
/* unused harmony reexport * */
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--3!./node_modules/vue-loader/dist/templateLoader.js??ref--6!./node_modules/vue-loader/dist??ref--2-0!./src/codemirror-editor.vue?vue&type=template&id=76a7bb16&bindings={}
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return Object(external_root_Vue_commonjs_vue_commonjs2_vue_amd_vue_["openBlock"])(), Object(external_root_Vue_commonjs_vue_commonjs2_vue_amd_vue_["createBlock"])(_component_v_md_container, {
    ...
    onResize: _ctx.handleContainerResize,
    ref: "contaner"
    ...
    editor: Object(external_root_Vue_commonjs_vue_commonjs2_vue_amd_vue_["withCtx"])(function () {
      return [Object(external_root_Vue_commonjs_vue_commonjs2_vue_amd_vue_["createVNode"])("div", {
        class: ["codemirror-wrapper", {
          'codemirror-reset': _ctx.codemirrorStyleReset
        }],
  ...
  /* PROPS, DYNAMIC_SLOTS */
  , ["left-toolbar", "right-toolbar", "toolbars", "disabled-menus", "height", "fullscreen", "left-area-visible", "left-area-title", "left-area-reverse", "mode", "onToolbarItemClick", "onToolbarMenuClick", "onResize"]);
}
// CONCATENATED MODULE: ./src/codemirror-editor.vue?vue&type=template&id=76a7bb16&bindings={}
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--3!./node_modules/vue-loader/dist??ref--2-0!./src/codemirror-editor.vue?vue&type=script&lang=js
...
var component = {
  ...
  mounted: function mounted() {
    ...
    if (!this.Codemirror) {
      return console.error('1.5.0与2.1.0版本之后Codemirror将由用户自己配置，请配置Codemirror，如何配置请参考相关文档');
    }

    this.codemirrorInstance = new this.Codemirror(this.$refs.codemirrorEditor, Object(esm_extends["a" /* default */])({
      lineNumbers: true,
    ...
    this.codemirrorInstance.on('scroll', function () {
      _this.handleEditorScroll();
    });
    this.codemirrorInstance.on('keydown', function (_, e) {
      _this.hotkeysManager.dispatch(e);
    });
    this.codemirrorInstance.on('drop', function (_, e) {
      _this.handleDrop(e);
    });
    this.codemirrorInstance.on('paste', function (_, e) {
      _this.handlePaste(e);
    });
    this.codemirrorInstance.on('blur', function (_, e) {
      _this.handleBlur(e);
    });
  },
  beforeUnmount: function beforeUnmount() {
    var element = this.codemirrorInstance.doc.cm.getWrapperElement();
    element == null ? void 0 : element.remove == null ? void 0 : element.remove();
  },
  methods: {
    handleContainerResize: function handleContainerResize() {
      if (!this.Codemirror) return; // 容器大小变化的时候刷新 codemirror 解决滚动条的显示问题
    ...
    getIndexInInterval: function getIndexInInterval(number, start, end) {
    ...
    getCursorLineLeftText: function getCursorLineLeftText() {
      ...
      var _codemirrorInstance$g = codemirrorInstance.getCursor('from'),
          startLine = _codemirrorInstance$g.line,
          startCh = _codemirrorInstance$g.ch;

      var _codemirrorInstance$g2 = codemirrorInstance.getCursor('to'),
          endLine = _codemirrorInstance$g2.line,
          endCh = _codemirrorInstance$g2.ch;
    ...
    editorScrollToTop: function editorScrollToTop(scrollTop) {
      ...
      var currentScrollTop = this.getScrollInfo().top;
      Object(smooth_scroll["b" /* smooth */])({
        currentScrollTop: currentScrollTop,
        scrollToTop: scrollTop,
        scrollFn: function scrollFn(scrollTop) {
          return _this2.codemirrorInstance.scrollTo(0, scrollTop);
        }
      });
    },
    // Must implement
    ...
    heightAtLine: function heightAtLine() {
      var _this$codemirrorInsta;

      return (_this$codemirrorInsta = this.codemirrorInstance).heightAtLine.apply(_this$codemirrorInsta, arguments);
    },
    // Must implement
    ...
    editorFocusEnd: function editorFocusEnd() {
      this.focus();
      var lastLineIndex = this.codemirrorInstance.lastLine();
      var lastLineContent = this.codemirrorInstance.getLine(lastLineIndex);
    ...
    // Must implement
    replaceSelectionText: function replaceSelectionText(text, type) {
      if (type === void 0) {
        type = 'around';
      }
    ...
    changeSelctionTo: function changeSelctionTo(insertText, selectedText) {
      ...
      var curStartLine = this.codemirrorInstance.getCursor('from');
      var curEndLine = this.codemirrorInstance.getCursor('to');
      ...
      var strLen = 0;
      lines.find(function (rowText, lineIndex) {
        var rowLength = rowText.length;
        [start, end].forEach(function (position) {
          var newCursor = _this3.getIndexInInterval(position.indexOfSelected, strLen, strLen + rowLength);
...
/* harmony default export */ var codemirror_editorvue_type_script_lang_js = (component);
// CONCATENATED MODULE: ./src/codemirror-editor.vue?vue&type=script&lang=js
 
// EXTERNAL MODULE: ./src/codemirror-editor.vue?vue&type=style&index=0&lang=scss
var codemirror_editorvue_type_style_index_0_lang_scss = __webpack_require__(107);

// CONCATENATED MODULE: ./src/codemirror-editor.vue





codemirror_editorvue_type_script_lang_js.render = render

/* harmony default export */ var codemirror_editor = (codemirror_editorvue_type_script_lang_js);
// EXTERNAL MODULE: ./src/utils/xss/index.js + 3 modules
var xss = __webpack_require__(7);
...
// CONCATENATED MODULE: ./src/codemirror-editor.js
// This file is auto generated by build/build-entry.js
...
var codemirror_editor_install = function install(app) {
  app.component(codemirror_editor.name, codemirror_editor);
};

codemirror_editor.version = version;
codemirror_editor.install = codemirror_editor_install;
codemirror_editor.xss = xss["a" /* default */];

codemirror_editor.use = function (optionsOrInstall, opt) {
  if (typeof optionsOrInstall === 'function') {
    optionsOrInstall(codemirror_editor, opt);
  } else {
    optionsOrInstall.install(codemirror_editor, opt);
  }

  return codemirror_editor;
};

/* harmony default export */ var src_codemirror_editor = __webpack_exports__["default"] = (codemirror_editor);
